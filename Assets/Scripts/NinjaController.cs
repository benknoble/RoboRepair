...
namespace NinjaController {
  ...
  public class NinjaController : MonoBehaviour {
    ...
    public bool IsOnWallLeft {
      get {
        return GetIsColliding(timeRealLastWallLeftCollision) && Input.GetKey(KeyCode.LeftArrow);
      }
    }

    public bool IsOnWallRight {
      get {
        return GetIsColliding(timeRealLastWallRightCollision) && Input.GetKey(KeyCode.RightArrow);
      }
    }
    ...
    public void Update() {
      ...
      GetComponent<Animator>().SetBool("InAir", isPlayerInAir);
    }
